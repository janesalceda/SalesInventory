...
CREATE PROCEDURE TotalCostIn
		@TransactionDate DATETIME,
		@ItemId VARCHAR(20)
		AS
		
SELECT 
isnull(sum(InvoiceDeliveryDetails.QtyOk*InvoiceDetails.UnitPrice),0) 'Cost'
...
CREATE PROCEDURE TotalCostOut
		@TransactionDate DATETIME,
		@ItemId VARCHAR(20)
		AS
		-- TOTAL OUT ITEMS
		SELECT 
		isnull(sum(StockOutDetails.UnitPrice * StockOutDetails.Qty),0) AS 'Cost'
