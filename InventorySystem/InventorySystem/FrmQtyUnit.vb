Public Class FrmQtyUnit
    ...
    Private Sub ExecuteQueries(Query As String)
        ...
        Else
            SQL.AddParams("@QtyUnitId", dtqtyunit.SelectedRows(0).Cells(0).Value.ToString())
    ...
    'Private Sub dtCategory_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dtqtyunit.CellDoubleClick
    ...
    '    If Not String.IsNullOrEmpty(txtDes.Text = dtqtyunit.SelectedRows(0).Cells(2).Value.ToString()) Then
